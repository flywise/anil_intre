...
class AddFamilyDetails2 extends StatefulWidget {
  const AddFamilyDetails2({Key? key}) : super(key: key);

  @override
  State<AddFamilyDetails2> createState() => _AddFamilyDetails2State();
}

class _AddFamilyDetails2State extends State<AddFamilyDetails2> {
  @override
